      ...
      try {
        ...
        const qrwc = await Qrwc.createQrwc({
          ...
          componentFilter: (componentState) => {
            // Only include the Pink_Noise_Generator component
            return componentState.Name === 'Pink_Noise_Generator' || componentState.Name === 'Responsalyzer' || componentState.Name === 'SPLMeter';
          }
        });
